...
<div class="page-header">
	<h2 class="text-center">Gestión de Usuarios y Empleados</h2>
</div>
...
<table class="table table-fixed table-bordered table-striped table-hover">
	...
	<tbody>
		<?php foreach ($usuarios as $usuario): ?>
			<tr>
				<td><?php echo imprimir_cadena($usuario['id_usuario'], $mysqli); ?></td>
	...
	<tfoot>
		...
		<tr>
			<th colspan="<?php echo $table_cols; ?>" class="align-middle text-center">
				<a href="?q=propuestas/nueva/">Registrar <?php echo $nueva . ' ' . $dic_propuesta; ?></a>
			</th>
		</tr>
	</tfoot>
</table>