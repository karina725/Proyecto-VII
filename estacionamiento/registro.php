...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
   ...
   try {
      ...
      // Insertar el usuario
      $stmt = $db_con->prepare("INSERT INTO usuarios (nombre_usuario, email, contraseña, id_rol, fecha_creacion) VALUES (:nombre_usuario, :email, :password, :id_rol, :fecha_creacion)");
